...
export default {
  ...
  setup(props, context) {
    ...
    const { search: searchProductCategories, categories: productCategories } = useCategory();
    ...
    const productCategoryName = computed(() => productCategories.value[0]?.name);
    ...
    onSSR(async () => {
      ...
      await searchProductCategories({ catId: [categories.value[0]] });
    });
